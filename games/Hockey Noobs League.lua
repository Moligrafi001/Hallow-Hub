...
if game.Players.LocalPlayer.Name == "MurdersRBLX" or "Moligrafi" then
...
local function SuperBlocker()
	while _G.SuperBlocker == true do
		game.workspace.MurdersRBLX.FightHitbox.Size = Vector3.new(5, 5, 5)
		game.workspace.MurdersRBLX.PlayerHitbox.Size = Vector3.new(5, 5, 5)
		game.workspace.MurdersRBLX.PassHitbox.Size = Vector3.new(5, 5, 5)
		game.workspace.MurdersRBLX.PushHitbox.Size = Vector3.new(5, 5, 5)
		wait(1)
	end
end
...
local Section = Menu:CreateSection("Shoot")
local Toggle =  Menu:CreateToggle({
   Name = "Super Shoot",
   CurrentValue = false,
   Callback = function(Value)
